...
insert into public.cat_arcade_scores (player_name, score, source, client_id, created_at)
select player_name, score, 'round', client_id, created_at
from public.prism_trio_scores
where client_id like 'cat-arcade:%'
on conflict (client_id) do nothing;

delete from public.prism_trio_scores
where client_id like 'cat-arcade:%';
