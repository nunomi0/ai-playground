...
test("cat arcade shows dated update notes", () => {
  ...
  assert.match(html, /Added 1v1 duel rooms with WebRTC rival streaming/);
  assert.match(html, /Separated duel room setup from random round start/);
  assert.match(html, /solo hides the rival panel/);
